...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      aiForecastDesc:
        "Predicted +18% income growth next month based on current sales velocity.",
      incoming: "Incoming",
      outgoing: "Outgoing",
    },
    about: {
    ...
    pricing: {
      ...
      description:
        "Choose the plan that fits your business scale and gives you the right tools to grow with confidence. Whether you’re just getting started or managing a growing business, you can upgrade or downgrade anytime as your needs change.",
      period: "/ month",
      ...
      matrixRows: [
        {
          name: "Incoming goods tracking",
          basic: true,
          business: true,
          entrepreneur: true,
        },
        {
          name: "Outgoing goods tracking",
          basic: true,
          business: true,
          entrepreneur: true,
        },
      ...
      plans: {
        basic: {
          ...
          price: "Rp49K",
          description:
            "For businesses that need simple and reliable daily records.",
  ...
  id: {
    ...
    dashboard: {
      ...
      aiForecastDesc:
        "Diprediksi tumbuh +18% pendapatan bulan depan berdasarkan performa saat ini.",
      incoming: "Masuk",
      outgoing: "Keluar",
    },
    about: {
    ...
    pricing: {
      ...
      description:
        "Pilih paket yang paling sesuai dengan skala dan kebutuhan bisnis Anda. Dapatkan fitur yang tepat untuk membantu bisnis Anda berkembang lebih optimal, tanpa harus membayar lebih dari yang diperlukan. Upgrade atau downgrade paket kapan saja sesuai dengan kebutuhan bisnis Anda.",
      period: "/ bulan",
      ...
      matrixRows: [
        {
          name: "Pencatatan barang masuk",
          basic: true,
          business: true,
          entrepreneur: true,
        },
        {
          name: "Pencatatan barang keluar",
          basic: true,
          business: true,
          entrepreneur: true,
        },
        {
          name: "Pencatatan keuntungan",
          basic: true,
          business: true,
          entrepreneur: true,
        },
        {
          name: "Analisis penjualan & chart",
          basic: false,
          business: true,
          entrepreneur: true,
        },
      ...
      plans: {
        basic: {
          ...
          price: "Rp49K",
          description:
            "Untuk bisnis yang membutuhkan pencatatan harian yang sederhana dan terpercaya.",
    ...
    contact: {
      ...
      form: {
        ...
        businessPlaceholder: "Masukkan nama bisnis Anda",
        message: "Pesan",
    ...
    loginModal: {
      ...
      forgotNotice:
        "Instruksi reset password telah dikirim ke email Anda (simulasi).",
